/** @file OctomapDoseServer.hpp
 * @brief Dose octomap server declaration
 *  Modified from OctomapServer.h
 * 
 * @author Tito Irfan (titoirfan)
 * @version 1.0 23/3/2021
 */

#ifndef OCTOMAP_DOSE_SERVER
#define OCTOMAP_DOSE_SERVER
...
#include <soca_octomap/tinycolormap.hpp>

namespace octomap_server {
class OctomapDoseServer {

public:
  typedef pcl::PointXYZ PCLPoint;
  typedef pcl::PointCloud<pcl::PointXYZ> PCLPointCloud;
  typedef octomap::OcTreeDose OcTreeT;
  typedef octomap_msgs::GetOctomap OctomapSrv;
  typedef octomap_msgs::BoundingBoxQuery BBXSrv;

  OctomapDoseServer(const ros::NodeHandle private_nh_ = ros::NodeHandle("~"), const ros::NodeHandle &nh_ = ros::NodeHandle());
  virtual ~OctomapDoseServer();
